...
// a mocked PUT is even recorded — a green-local, red-CI flake (e.g. lease-and-save "saves through PUT with
// the If-Match ETag …" asserting `calls.put` has length 1). The `testTimeout` in `vite.config.ts` is
// raised to sit above this.
