...
// Masking is by value (spec §8.3), so "env is always secret" would scrub an env-sourced model name
// out of every log event in the run — the author says which sourced values are secret.
